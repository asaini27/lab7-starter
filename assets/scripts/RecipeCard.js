...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let shadowRC1 = this.attachShadow({mode:'open'});
		// A2. TODO - Create an <article> element - This will hold our markup once our data is set
		let elementText = document.createElement('article');
		...
		shadowRC1.append(elementStyle);
		shadowRC1.append(elementText);
	}
	...
	set data(data) {
	  ...
	  <p class="${data.organization}">The Chef's Organization</p>
	  <div class="rating">
